...
/* package straylight-0.1.0 */
#define VERSION_straylight "0.1.0"
#define MIN_VERSION_straylight(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package yesod-core-1.4.33 */
#define VERSION_yesod_core "1.4.33"
#define MIN_VERSION_yesod_core(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  4 || \
  (major1) == 1 && (major2) == 4 && (minor) <= 33)
...
#define CURRENT_COMPONENT_ID "straylight-0.1.0-LfGVzgyVygyEq8qzsMY8zf"

#define CURRENT_PACKAGE_KEY "straylight-0.1.0-LfGVzgyVygyEq8qzsMY8zf"
